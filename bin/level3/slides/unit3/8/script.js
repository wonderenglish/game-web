...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1.setAttribute("transform", "translate(-200,160), scale(0.4)");
        L2.setAttribute("transform", "translate(290,125), scale(0.4)");
        L3.setAttribute("transform", "translate(340,170), scale(0.7)");
        L4.setAttribute("transform", "translate(200,280), scale(1)");
        L5.setAttribute("transform", "translate(-190,400), scale(0.7)");
        L6.setAttribute("transform", "translate(105,320), scale(0.5)");

        L1.setAttribute("transform", "matrix(1, 0, 0, 1, -200, 160), scale(" + L1S + ")");
        L2.setAttribute("transform", "matrix(1, 0, 0, 1, 290, 125), scale(" + L2S + ")");
        L3.setAttribute("transform", "matrix(1, 0, 0, 1, 340,170), scale(" + L3S + ")");
        L4.setAttribute("transform", "matrix(1, 0, 0, 1, 200, 280), scale(" + L4S + ")");
        L5.setAttribute("transform", "matrix(1, 0, 0, 1, -190,400), scale(" + L5S + ")");
        L6.setAttribute("transform", "matrix(1, 0, 0, 1, 105, 320), scale(" + L6S + ")");
