...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1 = svgDocument.getElementById("F2");
        L2 = svgDocument.getElementById("F1");

        Q.setAttribute('fill-opacity', '0');
        Q.setAttribute('stroke-opacity', '0');

        L1.setAttribute('fill-opacity', '0');
        L1.setAttribute('stroke-opacity', '0');
        L2.setAttribute('fill-opacity', '0');
        L2.setAttribute('stroke-opacity', '0');
    });
...
function buttonAction(elem) {
    ...
    if (elem == 3) {
        L2.setAttribute('fill-opacity', '1');
        L2.setAttribute('stroke-opacity', '1');
