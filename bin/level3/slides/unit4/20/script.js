...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        A11.setAttribute("transform", "matrix(1, 0, 0, 1, -330, 366)");
        A12.setAttribute("transform", "matrix(1, 0, 0, 1, -70, 366)");
        A21.setAttribute("transform", "matrix(1, 0, 0, 1, -210, 260) ");
        A22.setAttribute("transform", "matrix(1, 0, 0, 1, 40, 255)");
        A31.setAttribute("transform", "matrix(1, 0, 0, 1, -100, 128)");
