...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        var svgElement2 = svgDocument.getElementById("A1");
        ...
        var svgElement7 = svgDocument.getElementById("A6");
        ...
        $(svgElement2).click(function () {
            playSlideVoice('sound/A1', 1)
        });
        $(svgElement3).click(function () {
            playSlideVoice('sound/A2', 1)
        });
        $(svgElement4).click(function () {
            playSlideVoice('sound/A3', 1)
        });
        $(svgElement5).click(function () {
            playSlideVoice('sound/A4', 1)
        });
        $(svgElement6).click(function () {
            playSlideVoice('sound/A5', 1)
        });
        $(svgElement7).click(function () {
            playSlideVoice('sound/A6', 1)
        });
