...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1.setAttribute("transform", "translate(-200,930), scale(0.4)");
        L2.setAttribute("transform", "translate(770,1385), scale(0.3)");
        L3.setAttribute("transform", "translate(-50,680), scale(0.5)");
        L4.setAttribute("transform", "translate(-225,1560), scale(0.4)");
        L5.setAttribute("transform", "translate(-150,1160), scale(1)");
        L6.setAttribute("transform", "translate(635,1282), scale(0.6)");
