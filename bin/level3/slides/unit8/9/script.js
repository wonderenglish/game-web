...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        setListener('V11', 'V33', '1');  //Book
        setListener('V12', 'V15', '2');  //Post
        setListener('V13', 'V36', '3');  //Toy
        setListener('V14', 'V41', '4');  //Park
        setListener('V16', 'V56', '5');  //Rest
        setListener('V17', 'V31', '6');  //school
        setListener('V21', 'V61', '7');  //SHoe
        setListener('V22', 'V37', '8');  //Fire
        setListener('V23', 'V35', '9');  //Air
        setListener('V24', 'V47', '10'); //Gas
        setListener('V25', 'V43', '11'); //Bank
        setListener('V26', 'V51', '12'); //Auto
        setListener('V27', 'V55', '13'); //Police
        setListener('V32', 'V53', '14'); //Bakery
        setListener('V34', 'V45', '15'); //Dress
        setListener('V42', 'V44', '16'); //train
        setListener('V46', 'V54', '17'); //Super
        setListener('V52', 'V57', '18');
        showAllCards();
