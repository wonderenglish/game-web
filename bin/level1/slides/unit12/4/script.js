...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        svgElement1 = svgDocument.getElementById("QUEST"); //получаем любой элемент внутри svg
        svgElement2 = svgDocument.getElementById("L2"); //получаем любой элемент внутри svg
        svgElement3 = svgDocument.getElementById("L1"); //получаем любой элемент внутри svg
...
function buttonAction(elem) {
    ...
    if (elem == 2) {
        svgElement2.setAttribute('transform', 'translate(-50, 70)');
    ...
    if (elem == 4) {
        svgElement3.setAttribute('transform', 'translate(-50, -70)');
