    ...
    object.addEventListener('load', function () {
        ...
        $(svgElement7).click(function () {
            if (checkFrog('P1_1', 'bread')) {
                $(svgElement2).attr('style','transform: translate(-350px,300px)');
                setFrog('P2_1');
            }
        });
        $(svgElement8).click(function () {
            if (checkFrog('P1_2', 'ant')) {
                $(svgElement1).attr('style','transform: translate(300px,300px)');
                setFrog('P2_3');
            }
        });
        $(svgElement9).click(function () {
            if (checkFrog('P1_3', 'egg')) {
                $(svgElement5).attr('style','transform: translate(-600px,300px)');
                setFrog('P2_5');
            }
        });
        $(svgElement10).click(function () {
            if (checkFrog('P1_4', 'fries')) {
                $(svgElement6).attr('style','transform: translate(-560px,300px)');
                setFrog('P2_2');
            }
        });
        ...
        $(svgElement12).click(function () {
            if (checkFrog('P1_6', 'donut')) {
                $(svgElement4).attr('style','transform: translate(730px,300px)');
                setFrog('P2_4');
            }
        });
...
//$(svgElement2).attr('style','transform: translate(300px,300px)');
        ...
        $(svgElement13).click(function () {
            if (checkFrog('P2_1', 'bear')) {
                $(svgElement2).attr('style','transform: translate(-350px,580px)');
                setFrog('M2');
            }
        });
        $(svgElement14).click(function () {
            if (checkFrog('P2_2', 'fish')) {
                $(svgElement6).attr('style','transform: translate(-1160px,580px)');
                setFrog('M1');
            }
        });
        $(svgElement15).click(function () {
            if (checkFrog('P2_3', 'apple')) {
                $(svgElement1).attr('style','transform: translate(615px,580px)');
                setFrog('M6');
            }
        });
        $(svgElement16).click(function () {
            if (checkFrog('P2_4', 'dog')) {
                $(svgElement4).attr('style','transform: translate(40px,580px)');
                setFrog('M4');
            }
        });
        $(svgElement17).click(function () {
            if (checkFrog('P2_5', 'elephant')) {
                $(svgElement5).attr('style','transform: translate(100px,580px)');
                setFrog('M3');
            }
        });
        $(svgElement18).click(function () {
            if (checkFrog('P2_6', 'carrot')) {
                $(svgElement3).attr('style','transform: translate(1020px,580px)');
                setFrog('M5');
            }
        });
        ...
        $(svgElement24).click(function () {
            if (checkFrog('M6', 1)) {
                $(svgElement1).attr('style','transform: translate(1465px,890px)');
                clearFrog();
            }
        });
