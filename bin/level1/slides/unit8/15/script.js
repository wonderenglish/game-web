...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        $(svgElement6).click(function () {
            playSlideVoice('sound/dirty', 1)
        });
        $(svgElement7).click(function () {
            playSlideVoice('sound/Old', 1)
        });
        $(svgElement5).click(function () {
            playSlideVoice('sound/Scared', 1)
        });
        $(svgElement2).click(function () {
            playSlideVoice('sound/Young', 1)
        });
        $(svgElement4).click(function () {
            playSlideVoice('sound/big', 1)
        });
        $(svgElement3).click(function () {
            playSlideVoice('sound/small', 1)
        });
        $(svgElement8).click(function () {
            playSlideVoice('sound/Hungry', 1)
        });
        $(svgElement9).click(function () {
            playSlideVoice('sound/clean', 1)
        });
