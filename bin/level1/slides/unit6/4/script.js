$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        var svgElement = svgDocument.getElementById("L1"); //получаем любой элемент внутри svg
...
function buttonAction(elem) {
    ...
    if (elem == 2) {
        ...
        svgElement3.setAttribute("transform", "translate(-350,140), scale(1.2)");
    ...
    if (elem == 4) {
        var object = document.getElementById("svgelem"); //получаем элмент object
        var svgDocument = object.contentDocument; //получаем svg элемент внутри object
        var svgElement3 = svgDocument.getElementById("L4"); //получаем любой элемент внутри svg
        svgElement3.setAttribute("transform", "translate(-350,-120), scale(1.2)");
        setTimeout(function(){  svgElement3.setAttribute("transform", "translate(0,0), scale(1)"); }, 2000);
