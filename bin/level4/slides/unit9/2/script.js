...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        P1.setAttribute("transform", "matrix(1, 0, 0, 1, -80, 350), scale("+L0S+")");
        P2.setAttribute("transform", "matrix(1, 0, 0, 1, -80, 350), scale("+L1S+")");
        P3.setAttribute("transform", "matrix(1, 0, 0, 1, -32, 135), scale("+L2S+")");
        P4.setAttribute("transform", "matrix(1, 0, 0, 1, 400,  50), scale("+L3S+")");
        P5.setAttribute("transform", "matrix(1, 0, 0, 1, 470,  40), scale("+L4S+")");
        P6.setAttribute("transform", "matrix(1, 0, 0, 1, 80,   10), scale("+L5S+")");
        P7.setAttribute("transform", "matrix(1, 0, 0, 1, -40, 140), scale("+L6S+")");
