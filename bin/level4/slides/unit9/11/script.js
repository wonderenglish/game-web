...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        P1.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L0S+")");
        P2.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L1S+")");
        P3.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L2S+")");
        P4.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L3S+")");
        P5.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L4S+")");
        P6.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L5S+")");
        P7.setAttribute("transform", "matrix(1, 0, 0, 1, 0, 0), scale("+L6S+")");
