...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        let P10 = svgDocument.getElementById('A10');
        let P11 = svgDocument.getElementById('A11');
        let P12 = svgDocument.getElementById('A12');
        let P13 = svgDocument.getElementById('A13');
        let P14 = svgDocument.getElementById('A14');
        let P15 = svgDocument.getElementById('A15');
        let P16 = svgDocument.getElementById('A16');
        let P17 = svgDocument.getElementById('A17');
        let P18 = svgDocument.getElementById('A18');
        let P19 = svgDocument.getElementById('A19');
        let P20 = svgDocument.getElementById('A20');
        let P21 = svgDocument.getElementById('A21');
