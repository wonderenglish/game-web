...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        setListener('R1E2', 'R1E4', '4');
        setListener('R1E4', 'R1E2', '4');
        setListener('R1E3', 'R2E2', '2');
        setListener('R2E2', 'R1E3', '2');
        setListener('R2E1', 'R4E2', '1');
        setListener('R4E2', 'R2E1', '1');
        setListener('R2E3', 'R4E4', '6');
        setListener('R4E4', 'R2E3', '6');
        setListener('R3E1', 'R4E3', '5');
        setListener('R4E3', 'R3E1', '5');
        setListener('R3E2', 'R4E1', '7');
        setListener('R4E1', 'R3E2', '7');
    });
