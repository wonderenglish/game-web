...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1.setAttribute("transform", "translate(-240,220), scale(0.6)");
        L2.setAttribute("transform", "translate(-20,150), scale(0.6)");
        L3.setAttribute("transform", "translate(-120,150), scale(0.6)");
        L4.setAttribute("transform", "translate(150,250), scale(0.6)");
        L5.setAttribute("transform", "translate(95,175), scale(0.6)");
        L6.setAttribute("transform", "translate(-260,280), scale(0.6)");
        L7.setAttribute("transform", "translate(230,130), scale(0.6)");
        L8.setAttribute("transform", "translate(30,230), scale(0.6)");
