...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L8 = svgDocument.getElementById("L8");

        $(L1).click(function () {
            if($('#question').val() == 1){
                L1.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L2).click(function () {
            if($('#question').val() == 2){
                L2.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L3).click(function () {
            if($('#question').val() == 3){
                L3.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L4).click(function () {
            if($('#question').val() == 4){
                L4.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L5).click(function () {
            if($('#question').val() == 5){
                L5.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L6).click(function () {
            if($('#question').val() == 6){
                L6.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L7).click(function () {
            if($('#question').val() == 7){
                L7.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
        ...
        $(L8).click(function () {
            if($('#question').val() == 8){
                L8.setAttribute("transform", "translate(-0, -40), scale(1.2)");
                setTimeout(function () {
...
function buttonAction(elem) {
    ...
    if (elem == 1) {
        $("#question").val(1);
        playDuration('sound/1.mp3');
    }
    if (elem == 2) {
        $("#question").val(2);
        playDuration('sound/2.mp3');
    }
    if (elem == 3) {
        $("#question").val(3);
        playDuration('sound/3.mp3');
    }
    if (elem == 4) {
        $("#question").val(4);
        playDuration('sound/4.mp3');
    }
    if (elem == 5) {
        $("#question").val(5);
        playDuration('sound/5.mp3');
    }
    if (elem == 6) {
        $("#question").val(6);
        playDuration('sound/6.mp3');
    }
    if (elem == 7) {
        $("#question").val(7);
        playDuration('sound/7.mp3');
    }
    if (elem == 8) {
        $("#question").val(8);
        playDuration('sound/8.mp3');
    }
