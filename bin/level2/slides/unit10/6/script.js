...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1.setAttribute("transform", "translate(-140,250), scale(0.6)");
        L2.setAttribute("transform", "translate(-70,150), scale(0.6)");
        L3.setAttribute("transform", "translate(-30,150), scale(0.6)");
        L4.setAttribute("transform", "translate(170,310), scale(0.6)");
        L5.setAttribute("transform", "translate(-95,325), scale(0.6)");
        L6.setAttribute("transform", "translate(0,60), scale(0.6)");
        L7.setAttribute("transform", "translate(200,150), scale(0.6)");
        L8.setAttribute("transform", "translate(40,220), scale(0.6)");
