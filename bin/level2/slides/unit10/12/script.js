...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        G1 = svgDocument.getElementById("B7");
        G2 = svgDocument.getElementById("B8");
        G3 = svgDocument.getElementById("B9");
        G4 = svgDocument.getElementById("B10");
        G5 = svgDocument.getElementById("B11");
        G6 = svgDocument.getElementById("B12");
