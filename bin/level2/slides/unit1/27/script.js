...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        B1 = svgDocument.getElementById("BALL1");
        B2 = svgDocument.getElementById("BALL2");
        ...
        cards = [R1E1, R1E2, R1E3, R1E4, R2E1, R2E2, R2E3, R2E4, R3E1, R3E2, R3E3, R3E4, R4E1, R4E2, R4E3, R4E4];
        $(B1).click(function () {
        ...
        setListener('R1E1', 'R3E2', '5');
        setListener('R1E2', 'R2E3', '1');
        setListener('R1E3', 'R4E1', '8');
        setListener('R1E4', 'R3E3', '6');
        setListener('R2E1', 'R2E4', '4');
        setListener('R2E2', 'R3E4', '2');
        setListener('R2E3', 'R1E2', '1');
        setListener('R2E4', 'R2E1', '4');
        setListener('R3E1', 'R4E4', '3');
        setListener('R3E2', 'R1E1', '5');
        setListener('R3E3', 'R1E4', '6');
        setListener('R3E4', 'R2E2', '2');
        setListener('R4E1', 'R1E3', '8');
        setListener('R4E2', 'R4E3', '7');
        setListener('R4E3', 'R4E2', '7');
        setListener('R4E4', 'R3E1', '3');
    });
