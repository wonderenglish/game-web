    ...
    object.addEventListener('load', function () {
        ...
        $(HAIR).click(function () {
            if (checkFrog('', '2')) {
                ...
                setTimeout(function (args) { $(HAIR).find('.st14').attr('style', 'fill: #c1c1c1'); }, 2000);
            }
        });
        ...
        $(EYES).click(function () {
            if (checkFrog('', '3')) {
                ...
                setTimeout(function (args) {   $(EYES).find('.st31').attr('style', 'fill: #c1c1c1'); }, 2000);
            }
        });
        ...
        $(EYEBROWS).click(function () {
            if (checkFrog('', '4')) {
                ...
                setTimeout(function (args) {   $(EYEBROWS).find('.st26').attr('style', 'fill: #c1c1c1'); }, 2000);
            }
        });
        ...
        $(CHEEKS).click(function () {
            if (checkFrog('', '8')) {
                ...
                setTimeout(function (args) {  $(CHEEKS).find('.st17').attr('style', 'fill: #717171'); }, 2000);
            }
        });
