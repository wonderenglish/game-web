...
function buttonAction(elem) {
    ...
    if (elem == 1) {
        L1.setAttribute("transform", "translate(-20, -150), scale(1.2)");
        setTimeout(function () {
    ...
    if (elem == 2) {
        L2.setAttribute("transform", "translate(-100, -150), scale(1.2)");
        setTimeout(function () {
    ...
    if (elem == 3) {
        L3.setAttribute("transform", "translate(-80, -100), scale(1.2)");
        setTimeout(function () {
    ...
    if (elem == 7) {
        L7.setAttribute("transform", "translate(-80, -90), scale(1.2)");
        setTimeout(function () {
