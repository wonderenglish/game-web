...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        $(FACE).click(function () {
            if (checkFrog('', '2')) {
                $(FACE).attr('style', 'transform: translate(442px, 48px);');
        ...
        $(HAIR).click(function () {
            if (checkFrog('', '2')) {
                $(HAIR).attr('style', 'transform: translate(311px, 64px);');
        ...
        $(EYES).click(function () {
            if (checkFrog('', '2')) {
                $(EYES).attr('style', 'transform: translate(444px, -58px);');
        ...
        $(EYEBROWS).click(function () {
            if (checkFrog('', '2')) {
                $(EYEBROWS).attr('style', 'transform: translate(311px, -54px)');
        ...
        $(NOSE).click(function () {
            if (checkFrog('', '3')) {
                $(NOSE).attr('style', 'transform: translate(431px, -172px);');
        ...
        $(MOUTH).click(function () {
            if (checkFrog('', '3')) {
                $(MOUTH).attr('style', 'transform: translate(438px, -292px);');
        ...
        $(EARS).click(function () {
            if (checkFrog('', '3')) {
                $(EARS).attr('style', 'transform: translate(316px, -282px);');
        ...
        $(CHEEKS).click(function () {
            if (checkFrog('', '3')) {
                $(CHEEKS).attr('style', 'transform: translate(311px, -168px);');
