...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        $(L1).click(function () {
            if($('#question').val() == 1){
                L1.setAttribute("transform", "translate(-160, -120), scale(1.2)");
                setTimeout(function () {
        ...
        $(L8).click(function () {
            if($('#question').val() == 8){
                L8.setAttribute("transform", "translate(-50, -120), scale(1.2)");
                setTimeout(function () {
...
function buttonAction(elem) {
    ...
    if (elem == 1) {
        $("#question").val(1);
        playDuration('sound/donkey');
    }
    if (elem == 2) {
        $("#question").val(2);
        playDuration('sound/horse');
    }
    if (elem == 3) {
        $("#question").val(3);
        playDuration('sound/sheep');
    }
    if (elem == 4) {
        $("#question").val(4);
        playDuration('sound/goat');
    }
    if (elem == 5) {
        $("#question").val(5);
        playDuration('sound/pig');
    }
    if (elem == 6) {
        $("#question").val(6);
        playDuration('sound/cow',);
    }
    if (elem == 7) {
        $("#question").val(7);
        playDuration('sound/duck');
    }
    if (elem == 8) {
        $("#question").val(8);
        playDuration('sound/chicken');
    }
