...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1.setAttribute("transform", "translate(-40,260), scale(1)");
        L2.setAttribute("transform", "translate(-70,270), scale(1)");
        L3.setAttribute("transform", "translate(-90,180), scale(0.9)");
        L4.setAttribute("transform", "translate(-155,220), scale(1)");
        L5.setAttribute("transform", "translate(-50,255), scale(0.7)");
        L6.setAttribute("transform", "translate(0,280), scale(1)");
        L7.setAttribute("transform", "translate(-440,140), scale(1)");
        L8.setAttribute("transform", "translate(-140,100), scale(1)");
