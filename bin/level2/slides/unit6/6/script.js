...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1 = svgDocument.getElementById("L7");
        L2 = svgDocument.getElementById("L3");
        L3 = svgDocument.getElementById("L2");
        L4 = svgDocument.getElementById("L4");
        L5 = svgDocument.getElementById("L5");
        L6 = svgDocument.getElementById("L1");
        L7 = svgDocument.getElementById("L6");

        L6.setAttribute("transform", "translate(-40,80), scale(1)");
        L3.setAttribute("transform", "translate(-60,70), scale(1)");
        L2.setAttribute("transform", "translate(-110,250), scale(1)");
        L4.setAttribute("transform", "translate(-40,80), scale(1)");
        L7.setAttribute("transform", "translate(390,100), scale(1)");
        L1.setAttribute("transform", "translate(80,340), scale(1)");
        L5.setAttribute("transform", "translate(-40,230), scale(1)");
