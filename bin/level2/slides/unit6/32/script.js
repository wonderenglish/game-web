...
function buttonAction(elem) {
    ...
    if (elem == 1) {
        L1.setAttribute("transform", "translate(-80, -100), scale(1.2)");
        setTimeout(function () {
    ...
    if (elem == 5) {
        L5.setAttribute("transform", "translate(-80, -50), scale(1.2)");
        setTimeout(function () {
    ...
    if (elem == 6) {
        L6.setAttribute("transform", "translate(-50, -150), scale(1.2)");
        setTimeout(function () {
