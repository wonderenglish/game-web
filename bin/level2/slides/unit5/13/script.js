...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        L1.setAttribute("transform", "translate(-40,80), scale(1)");
        L2.setAttribute("transform", "translate(-70,80), scale(1)");
        L3.setAttribute("transform", "translate(-90,250), scale(1)");
        L4.setAttribute("transform", "translate(-40,80), scale(1)");
        L5.setAttribute("transform", "translate(390,410), scale(1)");
        L6.setAttribute("transform", "translate(-70,95), scale(1)");
        L7.setAttribute("transform", "translate(40,350), scale(1)");
