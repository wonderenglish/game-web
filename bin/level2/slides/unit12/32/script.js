...
$(document).ready(function () {
    ...
    object.addEventListener('load', function () {
        ...
        V71 = svgDocument.getElementById("71");
        V72 = svgDocument.getElementById("72");
        V73 = svgDocument.getElementById("73");
        V74 = svgDocument.getElementById("74");
        V75 = svgDocument.getElementById("75");
        V76 = svgDocument.getElementById("76");
        ...
        setListener('V11', 'V26', '1');  //Turtle
        setListener('V12', 'V22', '2');  //Gepard
        setListener('V13', 'V34', '3');  //Panda
        setListener('V14', 'V55', '4');  //Sheep
        setListener('V15', 'V35', '5');  //Eagle
        setListener('V16', 'V63', '6');  //Duck
        setListener('V17', 'V67', '7');  //Cow
        setListener('V21', 'V43', '8');  //Elef
        setListener('V23', 'V61', '9');  //Zebra
        setListener('V24', 'V42', '10'); //Pinguin
        setListener('V25', 'V27', '11'); //Wolf
        setListener('V31', 'V44', '12'); //Oslik
        setListener('V32', 'V56', '13'); //Rhino
        setListener('V33', 'V45', '14'); //Bear
        setListener('V36', 'V51', '15'); //Deer
        setListener('V37', 'V53', '16'); //Goat
        setListener('V41', 'V66', '17'); //Snake
        setListener('V46', 'V54', '18'); //Fox
        setListener('V47', 'V52', '19'); //Horse
        setListener('V57', 'V62', '20'); //Koala
        setListener('V64', 'V65', '21'); //Chicken
        setListener('V71', 'V74', '22'); //Croc
        setListener('V72', 'V76', '23'); //Jir
        setListener('V73', 'V75', '24'); //Pig
        showAllCards();
