...
$(document).ready(function () {
    ...
    object.addEventListener('load', () => {
        ...
        D2.setAttribute('style', 'transform: translateX(-55px)');
        D3.setAttribute('style', 'transform: translateX(-75px)');
        D4.setAttribute('style', 'transform: translateX(-90px)');
        D5.setAttribute('style', 'transform: translateX(-95px)');
        D6.setAttribute('style', 'transform: translateX(15px)');
        D7.setAttribute('style', 'transform: translateX(100px)');
