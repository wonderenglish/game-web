...
$(document).ready(function () {
    ...
    object.addEventListener('load', () => {
        ...
        let TIGER = svgDocument.getElementById("TIGER");
            ...
            A10 = svgDocument.getElementById("P110"),
            ...
            B10 = svgDocument.getElementById("P210"),
            ...
            C10 = svgDocument.getElementById("P310");
...
function buttonAction(elem) {
    switch (elem) {
        case '1':
            hideAll();
            playNewSlideVoice('Howmanyfarmersarethereinthelivingroom.mp3', 1);
            show("A", randomInteger(1, 10));
            break;
        case '2':
            hideAll();
            playNewSlideVoice('Howmanydancersarethereinthelivingroom.mp3', 1);
            show("B", randomInteger(1, 10));
            break;
        case '3':
            hideAll();
            playNewSlideVoice('Howmanystudentsarethereinthelivingroom.mp3', 1);
            show("C", randomInteger(1, 10));
            break;
        case '4':
