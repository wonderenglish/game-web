...
var winnerQueue = [2, 1, 3, 2, 1, 3, 2, 1, 3, 2, 1, 3, 2, 1, 3, 2, 1, 3];
var playQueue = [1, 2, 3,];
...
$(document).ready(function () {
    ...
    object.addEventListener('load', () => {
        ...
        P1 = svgDocument.getElementById("A1");
        P2 = svgDocument.getElementById("A2");
        P3 = svgDocument.getElementById("A3");
...
function buttonAction(elem) {
    switch (elem) {
        case '1':
            playNewSlideVoice('Isthereanappleonthebox.mp3', 1);
            setTimeout(() => {
                roundNewSound('play');
                carousel()
            }, 1000)
