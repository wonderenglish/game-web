...
$(document).ready(function () {
    ...
    object.addEventListener('load', () => {
        ...
        config = [
            {
                elem: P1,
                sound: 'Thereare4strawberriesonthetable'
            },
            {
                elem: P2,
                sound: 'Thereare3hamstersonthetable'
            },
            {
                elem: P3,
                sound: 'Thereare2booksonthetable'
            },
        ];
...
function buttonAction(elem) {
    switch (elem) {
        case '1':
            playNewSlideVoice('Howmanystrawberriesarethereonthetable.mp3', 1);
            ...
            break;
        case '2':
            playNewSlideVoice('Howmanyhamstersarethereonthetable.mp3', 1);
            ...
            break;
        case '3':
            playNewSlideVoice('Howmanybooksarethereonthetable.mp3', 1);
