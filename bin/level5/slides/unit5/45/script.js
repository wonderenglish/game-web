...
$(document).ready(function () {
    ...
    object.addEventListener('load', () => {
        ...
        config = [
            {elem: P1, sound: 'fat', change: true},
            {elem: P2, sound: 'fed', change: true},
            {elem: P3, sound: 'fix', change: true},
            {elem: P4, sound: 'fog', change: true},
            {elem: P5, sound: 'fun', change: true},
            {elem: P6, sound: 'van', change: true},
            {elem: P7, sound: 'vet', change: true},
            {elem: P8, sound: 'vat', change: true},
            {elem: P9, sound: 'fin', change: true},
            {elem: P10, sound:'fig', change: true},
        ];
