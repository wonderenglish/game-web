...
function buttonAction(elem) {
    switch (elem) {
        case '1':
            playNewSlideVoice('Arethere5eggplantsinthebowl.mp3', 1);
            break;
        case '2':
            playNewSlideVoice('Arethere3antsinthebowl.mp3', 1);
            break;
        case '3':
            playNewSlideVoice('Arethere4erasersinthebowl.mp3', 1);
            break;
        case '4':
            playNewSlideVoice('Yesthereare.mp3', 1);
            break;
        case '5':
            playNewSlideVoice('Notherearent.mp3', 1);
            break;
        case '20':
            replaySlide();
            break;
