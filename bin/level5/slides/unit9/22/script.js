    ...
    object.addEventListener('load', () => {
        ...
        config = [
...

            {
                elem: P11,
                sound: 'r',
                matrix: 'matrix(1 0 0 1 68.8001 80.2002)'
            },
            {
                elem: P12,
                sound: 'a'
...

            {
                elem: P21,
                sound: 'r',
                matrix: 'matrix(1 0 0 1 437.2384 80.2001)'
            },
            {
                elem: P22,
                sound: 'e'
...

            {
                elem: P41,
                sound: 'r',
                matrix: 'matrix(1 0 0 1 70.1794 351.8101)'
            },
            {
                elem: P42,
                sound: 'o'
...

            {
                elem: P51,
                sound: 'r',
                matrix: 'matrix(1 0 0 1 434.2384 351.8101)'
            },
            {
                elem: P52,
                sound: 'u'
