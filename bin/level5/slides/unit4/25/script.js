    ...
    object.addEventListener('load', () => {
        ...
        config = [
...

            {
                elem: P11,
                sound: 'j',
                matrix: 'matrix(1 0 0 1 83.8001 80.2002)'
            },
            {
                elem: P12,
                sound: 'a'
...

            {
                elem: P21,
                sound: 'j',
                matrix: 'matrix(1 0 0 1 452.2384 80.2001)'
            },
            {
                elem: P22,
                sound: 'e'
...

            {
                elem: P31,
                sound: 'j',
                matrix: 'matrix(1 0 0 1 263.9187 221.7399)'
            },
            {
                elem: P32,
                sound: 'i'
...

            {
                elem: P41,
                sound: 'j',
                matrix: 'matrix(1 0 0 1 85.1794 351.8101)'
            },
            {
                elem: P42,
                sound: 'o'
...

            {
                elem: P51,
                sound: 'j',
                matrix: 'matrix(1 0 0 1 450.2384 351.8101)'
            },
            {
                elem: P52,
                sound: 'u'
